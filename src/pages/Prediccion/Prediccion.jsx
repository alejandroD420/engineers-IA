    ...
    <SlideDeck>
      ...
      <section>
        <div className="hero">
          <h1>
            La IA{' '}
            <HighlightText text="NO piensa" highlight="NO" color="danger" />
            ,
            <HighlightText text="predice" highlight="predice" color="primary" />
          </h1>
          <p className="hero-subtitle">
            Un <Tooltip {...glossaryTerms.llm} />{' '}
      ...
      {/* Slide 1: ¿Qué significa esto? + Analogía del actor */}
      <section>
        <Grid columns={2} gap="large">
          <Card title="🧠 ¿Qué significa esto?" variant="primary">
            <p>
              La IA <Tooltip {...tooltips.noConciencia} />, no tiene
              intenciones, no razona.
            </p>
            ...
            >
              Es como el autocompletado de tu celular, pero entrenado con{' '}
              <strong>todo internet</strong>.
            </p>
          </Card>
      ...
      {/* Slide 2: Cómo predice la IA - Ejemplo real */}
      <section>
        <Card title="🔬 Cómo predice la IA: Ejemplo real" variant="primary">
          <div className="step-by-step">
            <div className="step-prompt">
              <strong>Usuario pregunta:</strong> "¿Cuál es la capital de
              Francia?"
            </div>
            ...
            >
              {showStepByStep
                ? '📖 Ocultar proceso'
                : '🎬 Ver cómo la IA construye la respuesta paso a paso →'}
            </button>

            {showStepByStep && (
              <div className="step-list">
                <p className="step-nota">
                  La IA NO planea la respuesta completa. Construye palabra por
                  palabra:
                </p>
                {pasosPrediccion.map((paso, idx) => (
                  <div key={idx} className="step-item">
                    ...
                    <div className="step-text">
                      ...
                      <span className="step-probabilidad">
                        ({paso.probabilidad} de probabilidad)
                      </span>
                    </div>
                  </div>
                ))}
                <div className="step-final">
                  <strong>✅ Respuesta final:</strong> "La capital de Francia es
                  París."
                </div>
              </div>
            )}
      ...
      {/* Slide 3: El bucle de predicción */}
      <section>
        <Card title="🔄 El bucle de predicción">
          ...
          <p className="loop-nota">
            * Un LLM no "piensa" una respuesta completa y luego la escribe. Es
            como un pianista que improvisa nota por nota.
          </p>
        </Card>
      </section>

      {/* Slide 4: Ejemplos de predicción */}
      <section>
        ...
        <Grid columns={2} gap="large">
          {ejemplos.map((ejemplo, idx) => (
            <Card
              ...
              onClick={() =>
                setSelectedExample(
                  selectedExample === idx ? null : idx
                )
              }
            >
              <div className="prediccion-ejemplo">
                <p className="prediccion-pregunta">
                  {ejemplo.inicio} <span className="cursor">_</span>
                </p>

                {selectedExample === idx && (
                  <div className="prediccion-respuesta">
                    <p>
                      🤖 La IA predice: <strong>"{ejemplo.prediccion}"</strong>
                    </p>
                    <p className="prediccion-completa">
                      📝 Frase completa: "{ejemplo.completado}"
                    </p>
                  </div>
                )}
      ...
      {/* Slide 5: Visualización + Frase final */}
      <section>
        <Card title="📊 Visualizando la predicción" variant="primary">
          <p style={{ marginBottom: '16px' }}>
            Para la frase <strong>"El cielo es de color"</strong>, la IA calcula
            probabilidades:
          </p>
          ...
          <p className="prob-nota">
            * La IA elige la palabra con mayor probabilidad. No "piensa" cuál es
            correcta.
          </p>
        </Card>
