  ...
  return (
    ...
    <SlideDeck>
      ...
      <section>
        ...
        {recursos.slice(0, 4).map((categoria, idx) => (
          <div key={idx} className="categoria-recursos">
            ...
            {idx < Math.min(4, recursos.length) - 1 && <Divider variant="light" spacing="small" />}
          </div>
        ))}
      </section>

      <section>
        {recursos.slice(4).map((categoria, idx) => (
          <div key={idx} className="categoria-recursos">
            <h2>{categoria.category}</h2>
            <Grid columns={3} gap="medium">
              {categoria.items.map((item, itemIdx) => (
            ...
            {idx < recursos.slice(4).length - 1 && <Divider variant="light" spacing="small" />}
          </div>
        ))}
      </section>
