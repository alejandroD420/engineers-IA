...
const Tokenizacion = () => {
  ...
  return (
    <div className="page-tokenizacion">
      <SlideDeck effects={["matrix-decode"]}>
        {/* Slide 0: Hero */}
        <section>
          <div className="hero">
            <h1>
              <HighlightText
                text="Tokenización"
                highlight="Tokenización"
                color="primary"
              />
              : el{" "}
              <HighlightText
                text="alfabeto secreto"
                highlight="secreto"
                color="warning"
              />
            </h1>
        ...
        {/* Slide 1: ¿Qué es? + ¿Por qué importante? */}
        <section>
          <Grid columns={2} gap="large">
            <Card title="🔍 ¿Qué es la tokenización?" variant="primary">
              <p>
                <Tooltip {...tooltips.tokenizacion} />
                es el proceso de dividir texto en{" "}
                <strong>fragmentos pequeños</strong>.
              </p>
              <p style={{ marginTop: "16px" }}>Un token puede ser:</p>
              <ul style={{ marginTop: "8px", marginLeft: "20px" }}>
                <li>
                  Una <strong>palabra completa</strong> ("Hola" → 1 token en
                  GPT-4o)
                </li>
                <li>
                  Una <strong>parte de palabra</strong> ("strawberry" → "Straw"
                  + "berry")
                </li>
                <li>
                  Un <strong>carácter individual</strong> ("." → 1 token)
                </li>
              </ul>
            </Card>
            ...
            <div className="qr-section">
              <div className="qr-info">
                ...
                <p className="qr-ejemplo">
                  Prueba con diferentes modelos: <strong>gpt-4o</strong> vs{" "}
                  <strong>gpt-3.5-turbo</strong>. ¡Verás la diferencia en
                  eficiencia!
                </p>
              </div>
        ...
        <section>
          <Card title="⚡ Comparación de eficiencia" variant="primary">
            <div className="comparacion-modelos">
              <div className="modelo-card">
                <div className="modelo-header gpt4">
                  <span className="modelo-icon">
                    {comparacionEficiencia.gpt4o.icono}
                  </span>
                  <span className="modelo-nombre">
                    {comparacionEficiencia.gpt4o.nombre}
                  </span>
                  <Badge
                    text={comparacionEficiencia.gpt4o.badge}
                    variant={comparacionEficiencia.gpt4o.badgeVariant}
                  />
                </div>
              ...
              <div className="modelo-card">
                <div className="modelo-header gpt35">
                  <span className="modelo-icon">
                    {comparacionEficiencia.gpt35.icono}
                  </span>
                  <span className="modelo-nombre">
                    {comparacionEficiencia.gpt35.nombre}
                  </span>
                  <Badge
                    text={comparacionEficiencia.gpt35.badge}
                    variant={comparacionEficiencia.gpt35.badgeVariant}
                  />
                </div>
                <div className="modelo-stats">
            ...
            <p className="comparacion-nota">
              💡 GPT-4o es hasta <strong>66% más eficiente</strong> que
              GPT-3.5-turbo. ¡Menos tokens = menos costo y más contexto
              disponible!
            </p>
          </Card>
        </section>

        {/* Slide 6: WOW + Frase final */}
        <section>
